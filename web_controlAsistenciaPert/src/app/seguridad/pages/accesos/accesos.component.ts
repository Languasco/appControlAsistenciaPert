...
export class AccesosComponent implements OnInit {
  ...
  constructor(private alertasService : AlertasService, private spinner: NgxSpinnerService, private loginService: LoginService,
              private usuarioService : UsuarioService , private funcionesglobalesService : FuncionesglobalesService) {            
  ...
  ngOnInit(): void {
   ...
   //----carga basica ----
   const menu = { text: 'ACCESOS PERT', value: -1, children: []}
  ...
  mostrarEventosMarcadosUsuario(){
    Swal.fire({
      ...
      allowOutsideClick: false,
      allowEscapeKey: false,
      text: 'Cargando eventos espere por favor'
    })
    Swal.showLoading();
